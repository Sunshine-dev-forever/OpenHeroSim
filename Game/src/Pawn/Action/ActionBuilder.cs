...
public class ActionBuilder {
    ...
    public static ActionBuilder Start(IPawnController ownerPawnController, System.Action executable) => new(ownerPawnController, executable);
