...
public class PawnGenerator
{
    ...
    {
        PawnControllerBuilder pawnControllerBuilder = PawnControllerBuilder.Start(nodeStorage, kdTreeController, navigationRegion3D)
                                                                           .Location(location)
                                                                           .SetGoals(pawnGoals)
    ...
    IPawnController CreateGoblin(PawnControllerBuilder pawnControllerBuilder)
    {
        ...
        return pawnControllerBuilder.SetPawnRig(ResourcePaths.GOBLIN_MODEL)
    ...
    IPawnController CreateWarrior(PawnControllerBuilder pawnControllerBuilder)
    {
        ...
        return pawnControllerBuilder.SetPawnRig(ResourcePaths.WARRIOR_MODEL)
                                    .AddAbility(AbilityDefinitions.STAB_ABILITY)
                                    .Finish();
    }
